        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
               <ul class="navbar-nav mr-auto">
                   <li class="nav-item active"><a class="nav-link" href="index.php"><i class="fa fa-home"></i> Home</a></li>
        ...
        <div class="container">
            <div class="row">             
                ...
                <div class="col-7 col-sm-5">
                    <h5>Our Address</h5>
                    <address>
                        121, Nerul Navi-Mumbai<br>
                        India<br>
		              <i class="fa fa-phone-square" aria-hidden="true"></i> : +852 1234 5678<br>
		              <i class="fa fa-fax" aria-hidden="true"></i> : +852 8765 4321<br>
		              <i class="fa fa-envelope" aria-hidden="true"></i> : <a href="mailto:donatelyme@gmail.com">donately.net</a>
		           </address>
                </div>
                <div class="col-12 col-sm-4 align-self-center">
                    <div class="text-center">
                        ...
                        <a class="btn btn-social-icon btn-youtube" href="http://youtube.com/"><i class="fa fa-youtube fa-lg" aria-hidden="true"></i></a>
                        <a class="btn btn-social-icon" href="mailto:"><i class="fa fa-envelope fa-lg" aria-hidden="true"></i></a>
                    </div>
                </div>
           </div>
           <div class="row justify-content-center">             
                <div class="col-auto">
                    <p>© Copyright 2020 Donately</p>
                </div>
           </div>
        </div>
    </footer>
